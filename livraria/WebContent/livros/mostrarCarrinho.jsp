...
<!-- Implementando o bean a ser usado nessa página -->
...
<!-- Conteúdo exibido na tela caso carrinho esteja vazio -->
...
<!-- verificando se há algo no carrinho para exibir na tela -->
<c:if test="${sessionScope.cart.numeroItens > 0}"> 
	...
	<!-- Gerando tabela com informações do carrinho -->
